import { StyleSheet, Dimensions, Text, View , TextInput, Touchable, TouchableOpacity} from 'react-native';
    ...
    <View style={styles.areatotal}>
      <View style={styles.areacalculo}>
        ...
        <View style={styles.areaexprecao}>
            <TextInput style={{textAlign: 'right',}} value={valor} onChangeText={(v1) => setValor(v1)} />
            <Text>{resultado}</Text>
        </View>
      </View>
      <View style={styles.areateclas}>
          <View style={styles.arealinha}>
              ...
              <TouchableOpacity style={styles.areabotao} onPress={() => adicionarOperacao('%')}>
          ...
          <View style={styles.arealinha}>
              <TouchableOpacity style={styles.areabotao} onPress={() => adicionarNumero('7')}>
                  <Text style={styles.textobotao}>7</Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.areabotao} onPress={() => adicionarNumero('8')}>
                  <Text style={styles.textobotao}>{8}</Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.areabotao} onPress={() => adicionarNumero('9')}>
                  <Text style={styles.textobotao}>9</Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.areabotao} onPress={() => adicionarOperacao('x')}>
                  <Text style={styles.textobotao}>x</Text>
              </TouchableOpacity>
          </View>
          <View style={styles.arealinha}>
              <TouchableOpacity style={styles.areabotao} onPress={() => adicionarNumero('4')}>
                  <Text style={styles.textobotao}>4</Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.areabotao} onPress={() => adicionarNumero('5')}>
                  <Text style={styles.textobotao}>5</Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.areabotao} onPress={() => adicionarNumero('6')}>
          ...
          <View style={styles.arealinha}>
              <TouchableOpacity style={styles.areabotao} onPress={() => adicionarNumero('1')}>
                  <Text style={styles.textobotao}>1</Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.areabotao} onPress={() => adicionarNumero('2')}>
                  <Text style={styles.textobotao}>2</Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.areabotao} onPress={() => adicionarNumero('3')}>
          ...
          <View style={styles.arealinha}>
              ...
              <TouchableOpacity style={styles.areabotao} onPress={() => adicionarNumero('0')}>
                  <Text style={styles.textobotao}>0</Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.areabotao} onPress={() => adicionarNumero('.')}>
                  <Text style={styles.textobotao}>.</Text>
              </TouchableOpacity>
